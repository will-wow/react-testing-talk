...
- Popular Node test framework 👍
- Usually paired with Chai for BDD expectations 🍵
...
- Enzyme Mount Snapshots for pages
...
- react-test-renderer shallow snapshot test for every component
...
# It's all just props => elements, events => spies
...
So the choice is mostly about what the team is familiar with, or
